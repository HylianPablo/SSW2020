...
insert into Plato (nombre,descripcion,desayuno,vegano,vegetariano,frutosSecos,gluten,kcal,glucidosSimples,polisacaridos,lipidos,proteinas,foto,enlace) Values ('Macarrones a la boloñesa','Macarrones con carne picada, tomate y orégano',FALSE,FALSE,FALSE,FALSE,TRUE,306,3,205,25,24,'MacarronesALaBolonesa.jpg','https://cookpad.com/es/recetas/4486568-macarrones-con-carne-picada');
