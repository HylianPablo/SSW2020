...
<body id="page-top">
    ...
    <div class="container rounded" id="cuerpo">
        ...
        <div class="row text-center my-3">
            ...
            <div class="col">
                <a class="coolFont btn w-100 actualPage" href="./ranking.jsp" role="button">TOP DIETAS</a>
            </div>
            <div class="col"></div>
        ...
        <div class="ScrollStyle p-2"> 
            ...
            %>
            <a class="text-decoration-none blackHref" href="dieta.jsp?cod=<%=dietas.get(i).getCodigoDieta()%>">
